"""
Automated Pytest for ecg-qrs-detector Enrichment Modules.
"""
import sys
...
from enrichment import (
    Continuous12leadEcgWaveformStreamingWithMultileadArrhythmiaClassificationEngine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    FilesToCreatemodifyEngine,
    AcceptanceCriteriaEngine,
    EchocardiographicStrainAnalysisIntegrationGlsGlpsEngine,
    ClinicalRationaleEngine,
    ImplementationPlanEngine,
    EcgqrsdetectorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = EcgqrsdetectorEnrichmentSuite()
